 ...
 */
function onResponseTransformFactoryFactory(typeChecker: ts.TypeChecker, compilationOptions: CompilationOptions): Factory {
...
export default {
    recompile: false,
    factory: onResponseTransformFactoryFactory
}
